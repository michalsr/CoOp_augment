...
class FixMatch(TrainerXU):
    ...
    def build_data_loader(self):
        ...
        #custom_tfm_train.append(tfm_train_strong)
        custom_tfm_train += [tfm_train_strong]
        custom_tfm_train = [tfm_train,[tfm_train,tfm_train_strong]]
    ...
    def parse_batch_train(self, batch_x, batch_u):
        # print(batch_x,'batchx')
        # print(batch_u,'batch u')
        input_x = batch_x["img"]
