...
def build_data_loader(
    ...
    # Build sampler
    #print(data_source,'THis is the data source')
...
class DataManager:
    ...
    def __init__(
        ...
        if type(tfm_train) == list:
            if len(tfm_train) == 2:
                print('Two different transforms')
                loader_x_train = tfm_train[0]
                loader_u_train = tfm_train[1]
            else:
                loader_x_train = tfm_train
        else:
            loader_x_train = tfm_train 
            loader_u_train =tfm_train
